...
// Determine the input type for the password field based on the checkbox
String passwordInputType = (showPassword != null && showPassword.equals("on")) ? "text" : "password";
%>
...
<body>
	<div class="container">
<!-- 		<h2 class="mt-4">View/Edit Profile</h2> -->
		...
		<form action="editProfile.jsp" method="post">
			...
			<div class="form-group">
				<label for="password">Password</label> <input
					type="<%=passwordInputType%>" class="form-control" id="password"
